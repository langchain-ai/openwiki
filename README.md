...
- **Coding-agent integrations** for Codex, Claude Code, and dcode, using the host's model and repository tools.
...
- **Coding-agent integrations:** let Codex, Claude Code, or dcode initialize and update repository wikis through OpenWiki's managed lifecycle.
