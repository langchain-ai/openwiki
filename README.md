...
The integration exposes lifecycle bookends plus Grounded Claims inspection and resolution. Codex, Claude, or OpenCode authors Markdown with native repository tools while OpenWiki validates and persists the evidence-backed propositions behind factual pages.
