...
export const OPENWIKI_LANGSMITH_MCP_ACCESS_TOKEN_ENV_KEY =
  "OPENWIKI_LANGSMITH_MCP_ACCESS_TOKEN";
export const OPENWIKI_LANGSMITH_MCP_CLIENT_ID_ENV_KEY =
  "OPENWIKI_LANGSMITH_MCP_CLIENT_ID";
export const OPENWIKI_LANGSMITH_MCP_REFRESH_TOKEN_ENV_KEY =
  "OPENWIKI_LANGSMITH_MCP_REFRESH_TOKEN";
