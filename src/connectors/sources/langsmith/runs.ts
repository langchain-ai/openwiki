...
/**
 * Light summary over the sampled trace roots. These are sample stats over the
 * pulled traces, not population stats: doing the arithmetic here keeps the update
