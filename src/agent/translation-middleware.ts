...
- In the YAML front matter, translate only the human-readable "title" and "description" values. Keep every front matter key and all other values byte-for-byte unchanged.
