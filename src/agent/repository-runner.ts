...
import { appendProjectSkill } from "./prompt.js";
import { readProjectSkill } from "./utils.js";
...
async function runPlanningAgent(
  ...
  const agent = createDeepAgent({
    ...
    subagents: [],
    permissions: AGENT_FILESYSTEM_PERMISSIONS,
    systemPrompt: appendProjectSkill(
      createRepositoryPlannerPrompt(view, planningContext),
      await readProjectSkill(run.root),
    ),
  });
