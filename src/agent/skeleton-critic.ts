...
- For every information-architecture request, name the exact planned paths or domain ownership that must change so the parent can repair and freeze the tree before authoring.
