...
```sh
pnpm integrations:dev <bob|codex|claude|opencode|cursor>
```
...
agent after installation. IBM Bob, Codex, Claude Code, OpenCode, and Cursor
...
configuration directory on every supported platform), and Cursor under
`~/.cursor`.
