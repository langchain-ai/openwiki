...
/**
 * Inputs for semantic re-evaluation of an already-generated KEB run.
 */
 ...
 *
 * @throws KebError when the saved run lacks the required checkpoint.
 */
function savedCheckpoint(
  savedResult: KebRunResult,
  checkpointId: string,
): CheckpointScore {
 ...
 * from a completed KEB run. Truth Package projection, temporal transitions,
 ...
 *
 * @throws KebError when the saved run does not match the selected benchmark.
 */
