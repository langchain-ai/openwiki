...
- **opencode**: `new OpenCodeModel(baseUrl, cwd, modelId)` — custom model that connects to a local OpenCode server via `@opencode-ai/sdk`, creates a session, and sends prompts through it.
