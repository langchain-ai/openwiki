...
- Supports multiple model providers — OpenRouter (default), Anthropic, OpenAI, Baseten, Fireworks, and AWS Bedrock — each with their own credentials and model list.
